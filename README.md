...
# Client Participation: The stability of asynchronous models improves with a higher number of participating clients. FedAsync\_4 was more stable than FedAsync\_2.
...
# For the centralized baseline, run the experiment\_pytorch.ipynb notebook.

# 

# For the federated learning experiments, run the experiment\_non-iid\_pytorch.ipynb notebook. You can modify the IID\_SENARIO and strategy selection within the notebook to test different configurations.
